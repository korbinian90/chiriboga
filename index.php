...
<head>
  ...
  <script>
    // (Removed the visibilitychange handler that re-clamped maximum-scale=1
    // and forced document.body.style.zoom=1. With pinch-zoom re-enabled,
    // those resets fought the user every time the tab regained focus.)
